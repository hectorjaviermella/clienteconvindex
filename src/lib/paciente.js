...
let mongoConfig = {
  ...
  //connection: 'mongodb://localhost:3000',
  //db_name: env.MONGO_DB_NAME,
  db_name: 'fhirdatabase',
  options: {
    //auto_reconnect: true,
...
let whitelist_env = (env.WHITELIST && env.WHITELIST.type.split(',').map((host) => host.trim())) || false;
...
let fhirServerConfig = {
  ...
  // Example:
  /* Account: {
  		service: './services/account/account.service.js',
  ...
  profiles: {
   /* Account: {
    ...
    Patient: {
      ...
      versions: [VERSIONS['4_0_1'],VERSIONS['4_0_0'], VERSIONS['3_0_1'], VERSIONS['1_0_2']],
    },
  },
};
//console.log('entra en config');
module.exports = {
  fhirServerConfig,
  mongoConfig,
};