...
clienteWSApp.on('connect', function(connection){
    ...
    connection.on('message',  function(message){
        ...
        console.log(resultadoenvio1json);
        console.log("////////////  json ");
        let myJSON = JSON.stringify(resultadoenvio1json);
        console.log(myJSON);

       console.log("//////////// usuario"); 
        const usuario= JSON.stringify(resultadoenvio1json.result.usuario);
            console.log(usuario);

        console.log("//////////// token"); 
        let tokenstring = resultadoenvio1json.result.token
        let token= JSON.stringify(resultadoenvio1json.result.token);
        //console.log(resultadoenvio1json.result.usuario);
        console.log(token);

        console.log("//////////// hospitales"); 
        let hospitales= JSON.stringify(resultadoenvio1json.result.hospitales);
        console.log(hospitales);
        ...
        let msjenvio4json = JSON.parse(msjenvio4);
