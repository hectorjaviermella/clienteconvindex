        ...
        if (response.type === 'utf8') {
            ...
            if (contador == 5) {
                ...
                if (resultjson.result.result != undefined) {
                    ...
                    var total = resultjson.result.result;
                    ...
                    console.log("////////////////////////////////////////////////////////////////////////////////////");
                    var laboratorios = resultjson.result.result.laboratorios;
                    console.log('laboratorios de json to fhir');
                    var fhirObservation = (0, observation_1.observationToFhir)(laboratorios);
